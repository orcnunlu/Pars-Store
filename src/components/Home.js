        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption d-none d-md-block">
              ...
              Yeni Ürünümüz Çok Yakında ParsStore Mağazamızda.
              </h6>
            </div>
          </div>
          <div className="carousel-item">
            ...
            <div className="carousel-caption d-none d-md-block">
              <h6 className="carousel-text text-dark fw-semibold">
              Yeni Takı Seti Yakında ParsStore Mağazasında.
              </h6>
            </div>
          </div>
          <div className="carousel-item">
          ...
          <div className="card p-1">
            <div className="d-flex justify-content-between align-items-center p-2 pb-3">
              <div className="flex-column lh-1 imagename fw-semibold">
                {" "}
                <span>Kadın</span> <span>Giyim</span>{" "}
              </div>
              <div>
                {" "}
                <img
        ...
        <div className="col-md-3">
          <div className="card p-2">
            <div className="d-flex justify-content-between align-items-center p-2">
              <div className="flex-column lh-1 imagename fw-semibold">
                {" "}
                <span>Erkek</span> <span>Giyim</span>{" "}
              </div>
              <div>
                {" "}
                <img
